...
config = {
    ...
    "node_list": [
        ...
        {"name": "hidden1", "dim": 256, "type": "linear", "activation": {"type": "relu"}},
        {"name": "hidden2", "dim": 75,  "type": "linear", "activation": {"type": "relu"}},
        {"name": "class",   "dim": 10,  "type": "linear", "activation": {"type": "relu"}},
    ],
